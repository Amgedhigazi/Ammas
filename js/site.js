(function () {
    ...
    header.innerHTML =
      ...
      '<nav>' +
        '<ul>' +
          ...
          '<li><a href="./Contact and reservaion.html"><span class="nav-icon"></span><span class="nav-label">Reservation</span></a></li>' +
        '</ul>' +
      '</nav>';
  }
  ...
  var NAV_ICONS = {
    ...
    'Contact and reservaion.html': '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" width="22" height="22"><path d="M17 12h-5v5h5v-5zM16 1v2H8V1H6v2H5c-1.11 0-1.99.9-1.99 2L3 19a2 2 0 002 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2h-1V1h-2zm3 18H5V8h14v11z"/></svg>'
  };
  ...
  if (footer) {
    footer.innerHTML =
      ...
      '<div class="footer-bottom">' +
        '<p>&copy; 2024 Browniz &mdash; All rights reserved &nbsp;|&nbsp; Photography &amp; Design by ' +
